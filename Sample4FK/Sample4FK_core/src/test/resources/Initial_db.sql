CREATE TABLE Assets_History (History_Id bigint NOT NULL, Asset_Id bigint NOT NULL, Asset_Name varchar(500), Location varchar(40), Description varchar(2000), Update_User varchar(50), Update_Dt timestamp, PRIMARY KEY (History_Id, Asset_Id));
...
CREATE TABLE Audti_Track (Trans_Id int GENERATED BY DEFAULT AS IDENTITY, Trans_user varchar(50), Trans_Date timestamp, Table_name varchar(40), "Column" varchar(40), Old_Value varchar(4000), New_Value varchar(4000), Operation varchar(50), comment varchar(1000), PRIMARY KEY (Trans_Id));
...
CREATE TABLE Asset_Type (Asset_Type varchar(40) NOT NULL, Type_Description varchar(2000), update_user varchar(50), PRIMARY KEY (Asset_Type));
